...
public class Setup4ConfigActivity extends Activity implements OnClickListener{
		...
		if(isprotected){
			...
			builder.setPositiveButton("开启", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					finish();
					System.out.println("要去激活activeAdmin");	
					activeAdmin();
					System.out.println("activeAdmin激活完毕");						
				}
			});
	...
	public void onClick(View v) {
		...
		case R.id.cb_setup4_start_protect:
			...
			if(isprotected){
				...
				editor.putBoolean("isprotected", true);
				editor.commit();
				System.out.println("点击复选框checkbox");					
		    	activeAdmin();
		    	System.out.println("框checkbox点击完毕");	
			}
			break;
	...
	private void activeAdmin() {
		System.out.println("进入activeAdmin()");	
		//申请权限
		...
		System.out.println("要离开activeAdmin()");	
	}
}
